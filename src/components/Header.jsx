...
const SEARCHABLE_PAGES = [
  ...
  { label: "External Renewal Customers", path: "/renewals/external-customers", icon: "mdi-card-account-details-outline", roles: ["admin", "instructor", "super_admin"] },
  { label: "Licence Expiries", path: "/renewals/licence-expiries", icon: "mdi-calendar-alert", roles: ["admin", "instructor", "super_admin"] },
  { label: "Vehicle Documents", path: "/renewals/vehicles", icon: "mdi-car-info", roles: ["admin", "instructor", "super_admin"] },
  { label: "Vehicle Document Expiries", path: "/renewals/vehicle-document-expiries", icon: "mdi-file-clock-outline", roles: ["admin", "instructor", "super_admin"] },
  { label: "Renewal Dashboard", path: "/renewals/dashboard", icon: "mdi-view-dashboard-outline", roles: ["admin", "instructor", "super_admin"] },
