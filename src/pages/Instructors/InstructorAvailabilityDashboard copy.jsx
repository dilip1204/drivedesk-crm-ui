...
function utilizationTint(bookedCount, totalCount) {
  if (!totalCount) return "";
  const pct = bookedCount / totalCount;
  if (pct === 0) return "bg-success-subtle";
  if (pct < 0.33) return "bg-success-subtle";
  if (pct < 0.66) return "bg-warning-subtle";
            ...
            <div className="content-wrapper">
              <div className="content">
                <div className="row">
                  ...
                  <div className="col-xl-6 text-right"></div>
                </div>
                      ...
                      <div className="card h-100">
                        <div className="card-body d-flex justify-content-center align-items-center">
                          <Donut
                            ...
                            max={100}
                            labelTop={`${summary.utilization_pct}%`}
                      ...
                      <div className="card h-100">
                        <div className="card-body">
                          <div className="d-flex align-items-center justify-content-between mb-2">
                            <h2 className="h6 m-0">
                              {new Date(year, monthIndex).toLocaleString(
                                undefined,
                          ...
                          <div className="d-flex justify-content-center">
                            <Donut
                              ...
                              max={summary.total_slots}
                              labelTop={summary.total_available}
                    ...
                    <div className="col-12 col-lg-12">
                      <div className="card">
                        <div className="card-body">
                          ...
                          <div className="row row-cols-7 g-2 text-center small text-secondary mt-2">
                            {"SUN MON TUE WED THU FRI SAT"
                              .split(" ")
                              .map((d) => (
                                <div key={d} className="col py-2">
                                  {d}
                                </div>
                              ))}
                          </div>
                            ...
                            {weeks.map((week, wi) => (
                              <React.Fragment key={wi}>
                                {week.map((cell, di) => {
                                  ...
                                  const tint = isSunday
                                    ? "bg-light"
                                    : utilizationTint(bookedCount, totalCount);
                                  return (
                                    <div
                                      key={iso}
                                      className={clsx("col", tint)}
                                    >
                                      <button
                                        onClick={() => setSelectedISO(iso)}
                                        className="w-100 h-100 text-start btn btn-light border"
                                        style={{ height: 112 }}
                                      >
                                        <div className="d-flex align-items-center justify-content-between">
  ...
  return (
    <div className="modal d-block" tabIndex="-1" role="dialog">
      <div
        ...
        role="document"
      >
        <div className="modal-content" style={{ zIndex: "999999" }}>
...
export default function InstructorAvailability() {
  ...
  const getInstructorAvail = () => {
    const data = { mobile_number: instructorId, month: currentMonth };
    dispatch(
      getInstructorAvailInformation(data, (res) => {
        const instructoravailList = res || [];
        //   if (Array.isArray(instructoravailList) && instructoravailList.length > 0) {
        setInstructorsData(instructoravailList);
        // } else {
        //   setInstructorsData([]);
