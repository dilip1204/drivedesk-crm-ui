...
const REMARK_OPTIONS = [
  ...
  "IMPROVE CLUTCH AT BITING POINT",
  "PRESS CLUTCH FULLY WHEN CHANGING GEAR",
  "IMPROVE GEAR CHANGING",
  "IMPROVE BITING POINT CONTROL",
  "SHIFT TO 1ST GEAR AFTER STOPPING",
  "IMPROVE DOWNSHIFTING",
